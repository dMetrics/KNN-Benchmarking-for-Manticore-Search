...
echo "[+] Creating cluster DMETRICS_FTS_1 on node 1 (mc-1)..."
# Run mysql INSIDE the mc-1 container
docker exec mc-1 mysql -h127.0.0.1 -P9306 -e "CREATE CLUSTER DMETRICS_FTS_1;" \
...
echo "[✅] Cluster DMETRICS_FTS_1 initialization complete."
